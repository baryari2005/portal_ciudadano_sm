      ...
      <DialogContent className="overflow-hidden rounded-2xl border-[#DDE5D8] bg-white p-0 shadow-[0_24px_70px_rgba(0,58,34,0.18)] sm:max-w-md">
        ...
        <DialogFooter className="border-t border-[#E4E9E3] bg-[#F7FAF3] px-5 py-4 sm:px-6">
          <DialogClose asChild>
            <Button
              variant="outline"
              className="h-11 rounded-lg border border-[var(--brand-primary)]/25 bg-white px-5 text-[var(--brand-primary)] shadow-sm hover:bg-[#EEF4E8] hover:text-[var(--brand-primary)] focus-visible:ring-[var(--brand-secondary)]/35"
              disabled={loading}
            >
              {cancelLabel}
            </Button>
          ...
          <Button
            ...
            className="h-11 rounded-lg bg-[var(--brand-primary)] px-5 text-white shadow-sm hover:bg-[#153D29] focus-visible:ring-[var(--brand-secondary)]/35"
          >
            {loading ? (
