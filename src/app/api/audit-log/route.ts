...
export async function GET(req: NextRequest) {
  try {
    ...
    requirePermission(user, "audit_log", "ver");
    ...
    return NextResponse.json({ data: await listAuditLogs(parsed.data) });
  } catch (error) {
    return mapApiRouteError(error, "No pudimos cargar el historial.");
  }
}
