...
export default function Loading() {
  return (
    ...
    >
      <div className="flex w-full max-w-md items-center gap-4 rounded-[18px] border border-[#DDE8D7] bg-[#EEF6E9] px-6 py-5 text-[#173C2A] shadow-sm">
        ...
        <div className="min-w-0">
          <p className="text-base font-extrabold text-[#003A22]">Cargando</p>
          <p className="mt-1 text-sm font-medium text-[#5F6F68]">
            Estamos preparando la informacion del sistema.
          </p>
        </div>
      </div>
    </section>
