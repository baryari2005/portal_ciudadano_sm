...
export const HELP_GUIDES: HelpGuide[] = [
  {
    ...
    title: "Registrarte e ingresar", description: "Solicitud de acceso, aprobación de la cuenta e inicio de sesión.",
    keywords: ["registro", "cuenta", "acceso", "contraseña", "solicitud", "aprobación"],
    steps: [
      "Desde la pantalla de acceso elegí Solicitar acceso y completá todos los pasos del formulario.",
      "Cargá tus datos personales, credenciales, domicilio, contacto, cobertura e imágenes y revisá la información antes de enviarla.",
      "Consultá el estado de la solicitud con tus credenciales. Si fue rechazada, revisá el motivo, corregí los datos y reenviá.",
      "Cuando la cuenta esté activa, iniciá sesión y elegí Portal Ciudadano.",
      "Si olvidaste la contraseña, utilizá la recuperación disponible en la pantalla de acceso.",
    ],
    warnings: ["Enviar la solicitud no habilita la cuenta inmediatamente: requiere revisión administrativa."],
    links: [{ label: "Solicitar acceso", href: "/request-access" }, { label: "Consultar estado", href: "/request-access/status" }],
  },
  {
    id: "citizen-home-navigation", category: "citizen", order: 20,
    title: "Usar el Portal Ciudadano", description: "Inicio, menú, indicadores y cambio entre experiencias disponibles.",
    keywords: ["inicio", "menú", "portal", "navegación", "indicadores", "experiencia"],
    steps: [
      "Inicio resume tus inscripciones confirmadas, listas de espera, próximas clases y asistencias.",
      "Usá las secciones Actividades, Mi cuenta y Comunicación del menú lateral para acceder a cada función.",
      "En pantallas chicas, abrí el menú desde el botón superior y cerralo al elegir una opción.",
      "La campana superior muestra avisos recientes y el contador de notificaciones sin leer.",
      "Si tu usuario posee otra función habilitada, utilizá el selector de experiencia para cambiar de portal.",
    ],
    links: [{ label: "Ir al inicio", href: "/citizen" }, { label: "Ver notificaciones", href: "/citizen/notifications" }],
  },
  {
    id: "citizen-profile", category: "citizen", order: 30,
    title: "Actualizar Mi perfil", description: "Datos personales, acceso, domicilio, contacto, cobertura e imágenes.",
    keywords: ["perfil", "datos", "domicilio", "cobertura", "avatar", "contraseña", "contacto"],
    steps: [
      "Abrí Mi perfil y elegí la sección que querés revisar en el menú del formulario.",
      "Actualizá los datos personales, domicilio, contacto de emergencia y cobertura médica que estén habilitados.",
      "Usá Datos de acceso para cambiar tu contraseña cuando sea necesario.",
      "En Imágenes podés actualizar el avatar y la foto solicitada mediante el control de carga compartido.",
      "Revisá los cambios y presioná Guardar; cambiar de sección no guarda automáticamente.",
    ],
    warnings: ["El DNI y otros datos sensibles pueden requerir intervención administrativa si no están habilitados para edición."],
    links: [{ label: "Abrir Mi perfil", href: "/citizen/profile" }],
  },
  {
    id: "citizen-find-activities", category: "citizen", order: 40,
    title: "Buscar actividades y elegir horarios", description: "Oferta disponible, días, turnos, cupos y validaciones previas.",
    keywords: ["actividad", "buscar", "horario", "día", "cupo", "profesor", "establecimiento"],
    steps: [
      "Abrí Actividades, buscá por nombre o descripción y seleccioná una tarjeta para consultar el detalle.",
      "Revisá categoría, nivel, requisitos, establecimiento, profesores y condiciones de la actividad.",
      "Marcá uno o varios días y horarios. Cada nuevo turno se valida antes de incorporarlo a la selección.",
      "Los horarios ya inscriptos se muestran marcados y los conflictos con otra actividad aparecen destacados en rojo.",
      "Cuando termines, presioná Continuar inscripción para revisar todo en una pantalla separada.",
    ],
    warnings: ["No podés seleccionar otra actividad que coincida en día y horario con una inscripción activa.", "La disponibilidad puede cambiar hasta confirmar la inscripción."],
    links: [{ label: "Ver actividades", href: "/citizen/activities" }],
  },
  {
    id: "citizen-enrollment-confirmation", category: "citizen", order: 50,
    title: "Confirmar una inscripción", description: "Revisión final, nivel informado, requisitos y resultado de la solicitud.",
    keywords: ["inscripción", "confirmar", "nivel", "condiciones", "pendiente", "lista de espera"],
    steps: [
      "Revisá la actividad y todos los días y horarios elegidos en la pantalla Confirmar inscripción.",
      "Leé el nivel informado y las condiciones obligatorias antes de continuar.",
      "Marcá las confirmaciones requeridas y presioná Confirmar inscripción.",
      "Mientras se procesa, el botón queda bloqueado y muestra el estado de carga para evitar envíos duplicados.",
      "La inscripción puede quedar confirmada, pendiente de documentación o en lista de espera según sus condiciones y cupos.",
    ],
    warnings: ["No cierres la pantalla mientras la confirmación está siendo procesada."],
    links: [{ label: "Buscar actividades", href: "/citizen/activities" }, { label: "Mis inscripciones", href: "/citizen/enrollments" }],
  },
  {
    id: "citizen-manage-enrollments", category: "citizen", order: 60,
    title: "Gestionar Mis inscripciones", description: "Estados, horarios actuales, cambios y cancelación de una actividad.",
    keywords: ["mis inscripciones", "cambiar horario", "cancelar", "baja", "estado", "espera"],
    steps: [
      "Abrí Mis inscripciones y seleccioná una actividad para ver su estado y los horarios registrados.",
      "Usá Cambiar horarios para abrir la pantalla de edición y marcar los nuevos días o turnos.",
      "Cada horario agregado vuelve a validar cupo y superposición antes de guardar.",
      "Confirmá el cambio solamente cuando la selección final sea correcta.",
      "Usá Cancelar inscripción si querés darte de baja completamente de la actividad.",
    ],
    warnings: ["Cambiar horarios conserva la inscripción; Cancelar inscripción da de baja toda la actividad.", "Al liberar un cupo puede avanzar otra persona de la lista de espera."],
    links: [{ label: "Abrir Mis inscripciones", href: "/citizen/enrollments" }],
  },
  {
    id: "citizen-upcoming-classes", category: "citizen", order: 70,
    title: "Consultar Próximas clases", description: "Navegación mensual, vistas de listado y calendario y detalle de cada clase.",
    keywords: ["próximas clases", "calendario", "mes", "listado", "reserva", "inasistencia"],
    steps: [
      "Elegí el mes con las flechas del período de consulta.",
      "Alterná entre Listado y Calendario según la vista que prefieras.",
      "Seleccioná una clase para consultar fecha, horario, establecimiento, profesor, estado y cupos cuando corresponda.",
      "En actividades por clase, reservá la fecha concreta desde el detalle y confirmá un cupo ofrecido si estabas en espera.",
      "Si no vas a asistir, informá la inasistencia y completá el motivo; podés adjuntar un comprobante cuando corresponda.",
    ],
    warnings: ["Próximas clases muestra fechas concretas generadas, no solamente el horario semanal de la inscripción.", "La justificación depende del plazo de aviso configurado para la actividad."],
    links: [{ label: "Ver Próximas clases", href: "/citizen/schedule" }],
  },
  {
    id: "citizen-attendance-qr", category: "citizen", order: 80,
    title: "Consultar asistencias y usar Mi QR", description: "Estados de asistencia y credencial digital para ingresos o clases.",
    keywords: ["asistencia", "presente", "ausente", "justificada", "qr", "credencial", "ingreso"],
    steps: [
      "Abrí Asistencias para consultar las clases procesadas y su estado: presente, ausente o justificada.",
      "Abrí Mi QR y emití la credencial si todavía no tenés una activa.",
      "Mostrá el QR en recepción para validar el ingreso o al responsable cuando se utilice para asistencia.",
      "Si la credencial deja de ser segura, revocala y emití una nueva.",
    ],
    warnings: ["No compartas capturas ni el contenido de tu QR.", "Una credencial revocada deja de ser válida inmediatamente."],
    links: [{ label: "Mis asistencias", href: "/citizen/attendance" }, { label: "Abrir Mi QR", href: "/citizen/qr" }],
  },
  {
    id: "citizen-documents", category: "citizen", order: 90,
    title: "Gestionar Mis documentos", description: "Carga, revisión y seguimiento de documentación personal o requerida.",
    keywords: ["documento", "archivo", "cargar", "aprobado", "rechazado", "pendiente", "requisito"],
    steps: [
      "Abrí Mis documentos para consultar los archivos presentados y su estado de revisión.",
      "Elegí el tipo de documento o requisito disponible y cargá el archivo con el control de subida.",
      "Revisá el nombre y formato antes de confirmar la carga.",
      "Consultá luego si quedó pendiente, aprobado o rechazado y leé las observaciones cuando existan.",
      "Si fue rechazado, corregí lo indicado y presentá una nueva versión.",
    ],
    warnings: ["Usá únicamente los formatos y tamaños admitidos por el control de carga."],
    links: [{ label: "Abrir Mis documentos", href: "/citizen/documents" }],
  },
  {
    id: "citizen-notifications", category: "citizen", order: 100,
    title: "Revisar Notificaciones", description: "Avisos sobre inscripciones, horarios, documentos y cambios de clases.",
    keywords: ["notificación", "aviso", "horario", "clase", "documento", "leer", "archivar"],
    steps: [
      "Consultá el contador de la campana superior para saber si tenés avisos sin leer.",
      "Abrí Notificaciones para ver el listado completo y seleccioná una tarjeta para leer su detalle.",
      "Usá la acción asociada para ir directamente a la inscripción, clase o documento relacionado.",
      "Marcá los avisos como leídos o archivialos cuando ya no necesites tenerlos pendientes.",
    ],
    warnings: ["Los cambios administrativos de días u horarios se informan mediante una notificación al ciudadano."],
    links: [{ label: "Ver Notificaciones", href: "/citizen/notifications" }],
  },
  {
