  ...
  return <section className="rounded-2xl border border-[var(--brand-border)] bg-[var(--brand-page)] p-5">
    <div className="flex items-start gap-3"><CalendarClock className="mt-0.5 size-5 text-[var(--brand-secondary)]" /><div className="flex-1">
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2">
        ...
        <div className="flex items-center justify-between rounded-xl border border-[var(--brand-border)] bg-white p-4"><Label>Requiere reserva previa</Label><Switch checked={value.requiereReserva} disabled={value.modalidadOperacion === "ACCESO_LIBRE"} onCheckedChange={(requiereReserva) => onChange({ requiereReserva })} /></div>
      </div>
    </div></div>
  </section>;
}
