...
export const listEnrollmentSessionsClient=async(activityId:string)=>(await axiosInstance.get<{data:ActivitySession[]}>("/enrollments/sessions",{params:{activityId}})).data.data;
