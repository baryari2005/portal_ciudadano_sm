...
const control = "h-12 w-full rounded-xl border-[#C9D9C3] bg-[#F7FBF5] pl-11 font-medium text-[#173C2A]";
function IconControl({ label, icon: Icon, children }: { label: string; icon: typeof Clock3; children: React.ReactNode }) { return <div className="space-y-2"><Label className="font-bold text-[#173C2A]">{label}</Label><div className="relative"><Icon className="pointer-events-none absolute left-3.5 top-3.5 z-10 size-5 text-[#1D4F36]" />{children}</div></div>; }
