...
export const saveActivityDraftSchema = z.object({ expectedUpdatedAt: z.string().datetime(), pasoActual: z.number().int().min(1).max(8).optional(), payload: activityDraftPayloadSchema });
