...
export const saveActivityDraftSchema = z.object({ expectedUpdatedAt: z.string().datetime(), pasoActual: z.number().int().min(1).max(7).optional(), payload: activityDraftPayloadSchema });
