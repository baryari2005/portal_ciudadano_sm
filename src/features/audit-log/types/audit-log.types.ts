...
export const AUDIT_ENTITIES = ["USUARIO","ROL","PERMISO","ACTIVIDAD","ESTABLECIMIENTO","PROFESOR","HORARIO_ACTIVIDAD","INSCRIPCION","CLASE_ACTIVIDAD","ASISTENCIA","REQUISITO","DOCUMENTO_INSCRIPCION","CREDENCIAL_QR","NOTIFICACION"] as const;
