...
function StatusBadge({ status }: { status: Resource["estado"] }) { return <Badge variant="outline" className={status === "ACTIVO" ? "border-[#819B56]/40 bg-[#DDEBCF] text-[#1D4F36]" : status === "MANTENIMIENTO" ? "border-amber-300 bg-amber-50 text-amber-900" : "border-[#B2B2B2] bg-[#E4E7E5] text-[#5F6F68]"}>{statusLabels[status]}</Badge>; }
